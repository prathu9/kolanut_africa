...
import QuotesTab from "./_components/quotes-tab";
...
const QuotesPage = () => {
    return(
        ...
        <header className="w-full px-10 py-[39px] flex justify-between items-center">
          <h2 className="text-[14px] leading-[20.3px] font-normal">Quotes</h2>
        ...
        <div className="px-10 py-10">
            <h2 className="mt-12 mb-[53px] text-[28px] font-semibold leading-[40.6px text-custom-grey">Quotes</h2>
            <QuotesTab />
        </div>
        </div>
    )
